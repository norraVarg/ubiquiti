describe('The ultimate e2e run', () => {
  it('Hopefully everthing works as expected :)', () => {
    ...
    cy.url().should('include', '/device?id=aa529bfc-4217-4942-96f8-1742b8ab8764')
    ...
    cy.url().should('include', '/device?id=0a34d79d-c382-4d5b-9b9b-8da38bdbd35c')
    cy.contains('h1', 'NanoStation loco M2').should('exist')
    cy.get('button[role="next-button"]').click().click()
    cy.url().should('include', '/device?id=693fcee9-13cc-438b-93bc-83de96848ad5')
    ...
    cy.url().should('include', '/device?id=af542e33-bf95-47fb-b891-a368ccb7fa40')
