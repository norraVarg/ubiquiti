  ...
  return (
    <div className='flex items-center justify-between'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <Tooltip
          trigger={
            <button onClick={onClickPrevious} disabled={!previousDevice} className={`${previousDevice ? 'opacity-100 hover:bg-web-unifi-color-neutral-2' : 'opacity-50'} flex items-center justify-center gap-2 rounded w-6 h-6 fill-web-unifi-color-neutral-8 rounded px-2 py-1 text-sm transition ease-in-out duration-300`}>
              <svg className='w-1.9 h-3.4'>
                <path d="M5.5 12a.501.501 0 0 1-.364-.157L.287 6.701A.994.994 0 0 1 0 6c0-.264.102-.513.287-.701L5.136.157a.5.5 0 0 1 .728.686L1 6l.01.01 4.854 5.146A.5.5 0 0 1 5.5 12Z" />
              </svg>
            </button>
        ...
        <Tooltip
          trigger={
            <button onClick={onClickNext} disabled={!nextDevice} className={`${nextDevice ? 'opacity-100 hover:bg-web-unifi-color-neutral-2' : 'opacity-50'} flex items-center justify-center gap-2 rounded w-6 h-6 text-web-unifi-text-0 text-opacity-45 fill-web-unifi-color-neutral-8 hover:bg-web-unifi-color-neutral-2 rounded px-2 py-1 text-sm transition ease-in-out duration-300`}>
              <svg className='w-1.9 h-3.4'>
