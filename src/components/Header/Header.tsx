...
export const Header = () => {
  return (
    <div className='h-12 sm:h-14 flex items-center bg-web-unifi-color-neutral-2 px-4 sm:px-8'>
      <Link to={'/'} className='fill-web-unifi-color-neutral-10 hover:fill-web-unifi-color-ublue-06 h-12 w-12 flex items-center justify-center border-web-unifi-color-ublue-06 rounded focus:border transition ease-in-out duration-300'>
