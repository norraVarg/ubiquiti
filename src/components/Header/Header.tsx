...
export const Header = () => {
  return (
    <div className='h-12 sm:h-14 flex items-center gap-x-3 bg-web-unifi-color-neutral-2 px-4 sm:px-8'>
      <Link to={'/'} role='logo' className='fill-web-unifi-color-neutral-10 hover:fill-web-unifi-color-ublue-06 h-12 w-12 flex items-center justify-center border-web-unifi-color-ublue-06 rounded focus:border transition ease-in-out duration-300'>
      ...
      <span className='text-web-unifi-text-3'>Devices</span>
      <Link to={'/demos'} role='demos'>
        <span className='text-web-unifi-text-3'>Demos</span>
      </Link>
