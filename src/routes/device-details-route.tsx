  ...
  return device ? (
    <div className='flex flex-col justify-center gap-4'>
      <div className='flex items-center justify-between'>
        ...
        <Link to={'/'} className='flex items-center gap-2 rounded w-16 h-6 text-web-unifi-text-0 text-opacity-45 fill-web-unifi-color-neutral-8 hover:fill-web-unifi-color-ublue-06 hover:text-web-unifi-color-ublue-06 hover:bg-web-unifi-color-neutral-2 rounded px-2 py-1 text-sm transition ease-in-out duration-300'>
        ...
        <div className='flex items-center gap-2'>
          {previousDevice ? (
            <button onClick={onClickPrevious} className='flex items-center justify-center gap-2 rounded w-6 h-6 text-web-unifi-text-0 text-opacity-45 fill-web-unifi-color-neutral-8 hover:fill-web-unifi-color-ublue-06 hover:text-web-unifi-color-ublue-06 hover:bg-web-unifi-color-neutral-2 rounded px-2 py-1 text-sm transition ease-in-out duration-300'>
              <svg className='w-1.9 h-3.4'>
                <path d="M5.5 12a.501.501 0 0 1-.364-.157L.287 6.701A.994.994 0 0 1 0 6c0-.264.102-.513.287-.701L5.136.157a.5.5 0 0 1 .728.686L1 6l.01.01 4.854 5.146A.5.5 0 0 1 5.5 12Z" />
              </svg>
            </button>
          ...
          {nextDevice ? (
            <button onClick={onClickNext} className='flex items-center justify-center gap-2 rounded w-6 h-6 text-web-unifi-text-0 text-opacity-45 fill-web-unifi-color-neutral-8 hover:fill-web-unifi-color-ublue-06 hover:text-web-unifi-color-ublue-06 hover:bg-web-unifi-color-neutral-2 rounded px-2 py-1 text-sm transition ease-in-out duration-300'>
              <svg className='w-1.9 h-3.4'>
